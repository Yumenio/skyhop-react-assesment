...
function App() {
  return (
    <div className='min-h-screen flex flex-col items-center'>
      <div>
        <h1 className='text-center text-3xl font-bold mt-10 mb-2'>Document Upload</h1>
      ...
      <h1 className="text-xl font-bold">Data in the import file is correct. Please press Continue to import.</h1>
